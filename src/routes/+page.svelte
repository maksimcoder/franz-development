...
<section class="section-fixed mb-[80px] lg:mb-[200px] sm:px-5 2lg:px-4">
  <h2 class="h2 lg:px-4 2xl:px-0">
...
<section
  class="section-fixed section-statistic lg:px-4 2xl:px-0"
>
  <div
    use:inview={{ unobserveOnEnter: true, rootMargin }}
